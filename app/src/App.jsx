  ...
  return (
    <div className="app-container">
      ...
      <main className="content" style={{ padding: gameState === 'stats' ? 0 : '1rem' }}>
        ...
        {gameState === 'results' && <Results score={score} isMultiplayer={isMultiplayer} roomData={roomData} questions={questions} userAnswers={userAnswers} config={config} resetGame={resetGame} onShowGlobalStats={openGlobalDashboard} />}
